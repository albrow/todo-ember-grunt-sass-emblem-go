    ...
    Emblem.Parser = (function() {
      ...
      function parse(input) {
        var options = arguments.length > 1 ? arguments[1] : {},
          ...
          peg$c44 = " [",
          peg$c45 = "\" [\"",
          peg$c46 = function(path, params, hash) {
          ...
          peg$c51 = function(id, classes) {
            return [id, classes];
          },
          peg$c52 = function(classes) {
            return [null, classes];
          },
          peg$c53 = function(p) {
            return p;
          ...
          peg$c64 = /^[^\]]/,
          peg$c65 = "[^\\]]",
          peg$c66 = function(segmentLiteral) {
          ...
          peg$c160 = function(id) {
            return createMustacheNode([id], null, true);
          },
          peg$c161 = function(event, mustacheNode) {
            ...
            return [unshiftParam(mustacheNode, 'action', [
              ['on', new AST.StringNode(event)]
            ])];
          },
          ...
          peg$c167 = function(key, value) {
            var hashNode = new AST.HashNode([
              [key, new AST.StringNode(value)]
            ]);
            var params = [new AST.IdNode([{
              part: 'bind-attr'
            }])];
        ...
        function createMustacheNode(params, hash, escaped) {
          if (use11AST) {
            ...
            return new AST.MustacheNode(params, hash, open, {
              left: false,
              right: false
            });
          } else {
            ...
            if (classes.length) {
              ...
              if (isClassAttr && fullAttributes[i].length === 4) {
                if (fullAttributes[i][2].type == 'mustache') {
                  ...
                  params = [new AST.IdNode([{
                    part: 'bind-attr'
                  }])].concat(mustacheNode.params);
